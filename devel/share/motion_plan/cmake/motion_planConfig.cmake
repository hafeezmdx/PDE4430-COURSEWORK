...
if("TRUE" STREQUAL "TRUE")
  set(motion_plan_SOURCE_PREFIX /home/lenovo/chapter-02/src/two-wheeled-robot-motion-planning)
  set(motion_plan_DEVEL_PREFIX /home/lenovo/chapter-02/devel)
  ...
  set(motion_plan_INSTALL_PREFIX /home/lenovo/chapter-02/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'motion_plan' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lenovo/chapter-02/src/two-wheeled-robot-motion-planning/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lenovo/chapter-02/devel/lib;/home/lenovo/chapter-02/devel/lib;/opt/ros/kinetic/lib)
