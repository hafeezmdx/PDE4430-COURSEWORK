...
if("TRUE" STREQUAL "TRUE")
  set(teleop_twist_keyboard_SOURCE_PREFIX /home/lenovo/chapter-02/src/teleop_twist_keyboard-master)
  set(teleop_twist_keyboard_DEVEL_PREFIX /home/lenovo/chapter-02/devel)
  ...
  set(teleop_twist_keyboard_INSTALL_PREFIX /home/lenovo/chapter-02/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'teleop_twist_keyboard' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lenovo/chapter-02/src/teleop_twist_keyboard-master/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lenovo/chapter-02/devel/lib;/home/lenovo/project2_ws/devel/lib;/opt/ros/kinetic/lib)
